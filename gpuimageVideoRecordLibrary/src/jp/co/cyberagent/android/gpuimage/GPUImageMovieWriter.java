...
public class GPUImageMovieWriter extends GPUImageFilter {
    ...
    public void onDraw(int textureId, FloatBuffer cubeBuffer, FloatBuffer textureBuffer) {
        ...
        if (mIsRecording) {
            ...
            if (mCodecInput == null) {
                Log.d("GPUImageMovieWriter", "mCodecInput_init");
            ...
            if (mCodecInput == null) Log.d("GPUImageMovieWriter", "mCodecInput==null");
            super.onDraw(textureId, cubeBuffer, textureBuffer);//どうやらここの処理でmCodecInputがnullになる事がある
            if (mCodecInput == null) {//対処
                Log.e("GPUImageMovieWriter", "不規則なエラー");
    ...
    public void onDestroy() {
        Log.d("GPUImageMovieWriter", "onDestroy:" + identityHashCode(this));
    ...
    public void startRecording(final String outputPath, final int width, final int height) {
        //Log.d("GPUImageMovieWriter","startRecording:"+identityHashCode(this));
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                Log.d("GPUImageMovieWriter", "startRecording_run:" + identityHashCode(GPUImageMovieWriter.this));
    ...
    public void stopRecording() {
        //Log.d("GPUImageMovieWriter","stopRecording:"+identityHashCode(this));
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                if (!mIsRecording) {
                ...
                Log.d("GPUImageMovieWriter", "stopRecording_run:" + identityHashCode(GPUImageMovieWriter.this));
                mMuxer.stopRecording();
                mIsRecording = false;
                releaseEncodeSurface();
            }
